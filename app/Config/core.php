 ...
 */
	Configure::write('Security.salt', 'Us78345hjd374dfs34hjhH4i');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '321651651684321651651651812316');
 ...
 */
 Configure::write('Hybridauth', array(
    ...
    "Google" => array(
        "enabled" => true,
        "keys" => array("id" => "995025043668-vitpfq4ov43dmkku48u8cd7eug1dt593.apps.googleusercontent.com","secret" => "GWoC583Q3G2633OWYSotzJE2"),
    ),
    "Twitter" => array(
        "enabled" => true,
        "keys" => array("key" => "eVcLgB7Rs5JElA67F1YDtruMN", "secret" => "u2fFCwfnpneu1kKLUyKGrZCdYXnjqbEw6Z0Dbia4bkqFppFbiZ")
    ),
    "Facebook" => array(
        "enabled" => true,
        "keys" => array("id" => "367931116892068", "secret" => "3cda7966e0d4e80bf2286e5f7c0c7eb6"),
    ),
    "OpenID" => array(
        "enabled" => false
    ),
    ...
    "Microsoft" => array(
        "enabled" => true,
        "keys" => array("id" => "775a757d-d767-4dda-ae1e-a05803ed8f60", "secret" => "aWmyHwmpKoMe40KWGW40bMC")
    ),
));
