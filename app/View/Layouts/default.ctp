...
<head>
  ...
  <!-- Daterange picker -->
  <link rel="stylesheet" href="<?php echo $this->webroot;?>plugins/daterangepicker/daterangepicker.css">
  ...
  <!--[if lt IE 9]>
  <script src="<?php //echo $this->webroot;?>https://oss.maxcdn.com/html5shiv/3.7.3/html5shiv.min.js"></script>
  <script src="<?php //echo $this->webroot;?>https://oss.maxcdn.com/respond/1.4.2/respond.min.js"></script>
  <![endif]-->
</head>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-mini"><b>U</b>SM</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Base</span>
    </a>
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                 <?php echo $this->Session->read('Auth.User.username'); ?> - Web Developer
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class=" treeview">
          <a href="#">
            <i class="fa fa-dashboard"></i> <span>Dashboard Management</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li class="active"><a href="<?php echo $this->base; ?>/Users/add"><i class="fa fa-circle-o"></i> Add New User</a></li>
            <li><a href="<?php echo $this->base; ?>/Users/index"><i class="fa fa-circle-o"></i> Users </a></li>
          </ul>
...
<!-- jQuery 2.2.3 -->
<script src="<?php echo $this->webroot;?>plugins/jQuery/jquery-2.2.3.min.js"></script>
<!-- jQuery UI 1.11.4 -->
<script src="<?php echo $this->webroot;?>https://code.jquery.com/ui/1.11.4/jquery-ui.min.js"></script>
...
<!-- Morris.js charts -->
<script src="<?php echo $this->webroot;?>https://cdnjs.cloudflare.com/ajax/libs/raphael/2.1.0/raphael-min.js"></script>
...
<!-- daterangepicker -->
<script src="<?php echo $this->webroot;?>https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.11.2/moment.min.js"></script>
...
<!-- FastClick -->
<script src="<?php echo $this->webroot;?>plugins/fastclick/fastclick.js"></script>
<!-- AdminLTE App -->
