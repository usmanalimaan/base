...
<body class="hold-transition login-page" style="background-image:url(<?php echo $this->webroot;?>/img/login-bg.jpg);">
<div class="register-box">
  <div class="register-logo">
    <!-- <a href="<?php echo $this->webroot; ?>/index2.html"><b>Admin</b>LTE</a> -->
  </div>
