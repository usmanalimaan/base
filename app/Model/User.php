...
class User extends AppModel 
{
     ...
     */
     public function beforeSave($options = array()) {
        ...
        if(isset($this->request->data[$this->alias]['password_update']) && !empty($this->request->data[$this->alias]['password_update'])) 
        {
            $this->request->data[$this->alias]['password'] = AuthComponent::password($this->request->data[$this->alias]['password_update']);
        }
